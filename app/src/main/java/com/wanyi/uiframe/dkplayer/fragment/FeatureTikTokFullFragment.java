...
public class FeatureTikTokFullFragment extends BaseFragment implements TikTokCallBack, CommentDialog.CallBack, INetWorkView,
    ...
    protected IDynamicMovieAction getDataSource() {
        return FeatureMovieAction.getInstance();
    }
