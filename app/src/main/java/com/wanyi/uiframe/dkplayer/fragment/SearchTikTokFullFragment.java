...
import com.wanyi.uiframe.dkplayer.adapter.SearchTiktok3Adapter;
...
public class SearchTikTokFullFragment extends BaseFragment implements TikTokCallBack, CommentDialog.CallBack, INetWorkView,
    ...
    private SearchTiktok3Adapter mTiktok3Adapter;
    ...
    protected void initView() {
        ...
        mTiktok3Adapter = new SearchTiktok3Adapter(mVideoList);
    ...
    protected IDynamicMovieAction getDataSource() {
        return SearchMovieAction.getInstance();
    }
    ...
    SearchTiktok3Adapter.ViewHolder tiktokVH = null;
    /**
     * 开始播放视频，用VideoView缓存
     * @param position
     */
    private void startPlay(int position) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            SearchTiktok3Adapter.ViewHolder viewHolder = (SearchTiktok3Adapter.ViewHolder) itemView.getTag();
            tiktokVH = viewHolder;
