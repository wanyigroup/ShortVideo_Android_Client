...
public class SearchTiktok3Adapter extends RecyclerView.Adapter<SearchTiktok3Adapter.ViewHolder> {
     ...
     * 视频更新
     */
    private HashMap<String, SearchTiktok3Adapter.ViewHolder> videoKeyHash = new HashMap<>();
    ...
    public SearchTiktok3Adapter(List<IPreMovieVO> videoBeans) {
    ...
    @NonNull
    @Override
    public SearchTiktok3Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tik_tok_search, parent, false);
        return new SearchTiktok3Adapter.ViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(@NonNull SearchTiktok3Adapter.ViewHolder holder, int position) {
    ...
    @Override
    public void onViewDetachedFromWindow(@NonNull SearchTiktok3Adapter.ViewHolder holder) {
