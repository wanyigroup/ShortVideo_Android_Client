...
public class LocationHelper {
     ...
     */
    public static void request(Context context, Consumer<LocationInfo> consumer) {
        LocationClient  mLocationClient = new LocationClient(context.getApplicationContext());     //声明LocationClient类
        MyLocationListener myLocationListener =new MyLocationListener(consumer,mLocationClient);
